...
### 모듈2 · AI의 이해와 사용_Agt1
- **퀘스트** — [트랜스포머 발표](03_module2/b_q_A-transformer-preso/)
- **노드5 · 8강 과제** — [원하는 포즈로 만들기](03_module2/d_hw_N5-pose-image-tool/) · [Colab에서 열기 ↗](https://colab.research.google.com/github/kimjy0977/KDT_Works/blob/main/03_module2/d_hw_N5-pose-image-tool/pose_tool.ipynb)
