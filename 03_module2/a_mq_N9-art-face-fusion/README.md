...
**다음 단계 확장 설계:**
- **다른 명화로 확장** — 코어 파이프라인은 특정 명화에 의존하지 않으므로 `target`(canny 구도 소스)만 교체하면 적용된다. 난도별 로드맵:

| 타겟 명화 | 인원·특징 | 예상 난도 | 상태 |
|---|---|---|---|
| 진주 귀고리를 한 소녀 (본 PoC) | 1인·정면 | ★☆☆ | ✅ 완료 |
| 천지창조 | 2인·손 맞닿음 | ★★☆ | 확장 예정 (손 디테일·2인 정체성) |
| 아비뇽의 처녀들 | 5인·큐비즘 | ★★★ | 도전 (추상 화풍 → 얼굴 정합) |
| 최후의 만찬 | 13인 | ★★★ | 한계 시연 (얼굴 13개 각각) |

- **파인튜닝**(특정 인물 LoRA) 정체성↑ · **SDXL·업스케일** 해상도↑ · **웹 데모 배포**(선택).
