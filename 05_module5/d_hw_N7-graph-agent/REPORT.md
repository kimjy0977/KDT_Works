...
|---|---|---|---|---|---|
| 1홉 | 3×3 | **100.0%** | 66.7% | 1.4 | 0.0% |
| 2홉 | 4×3 | 50.0% | 66.7% | 1.3 | 0.0% |
| 4홉 | 4×3 | **83.3%** | 57.5% | 1.3 | 0.0% |
| ★거절 | 3×3 | **100.0%** | — | 0.6 | ★0.0% (구조적) |
| 전체 | 42 | **81.0%** | | | 0.0% |
...
**⇒ 4홉은 75.0% → 83.3% 로 움직였고**, 그 차이가 전부 **4홉-02 한 문항**에서 왔습니다.

### ★`temperature=0` 인데 흔들린다

`4홉-02` 가 1/3 이라는 것은 **같은 입력에 다른 답**이 나왔다는 뜻입니다.
