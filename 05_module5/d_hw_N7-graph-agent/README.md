...
*「영화 《인터스텔라》와 «같은 가치 대립»을 다루는 다른 영화를 추천하고, 어떤 대립을 공유하는지」*
★**답변 · 탄 경로 117개 · 근거 삼중항 60개 · 출처 문서**가 한 화면에 나옵니다.

★**URL 로도 질문할 수 있습니다** — `http://localhost:8511/?q=질문&hop=4`
링크 하나로 «결과 화면»을 그대로 공유합니다.
