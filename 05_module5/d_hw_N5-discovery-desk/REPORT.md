...
| ① 의도 분류 | macro F1 **0.915** (gpt-5.6-luna) · 범위 밖 탐지 78.6~85.7% · 폭 0.000 |
| ② 답변 통과율 | **평균 73.3%** (gpt-5.6-terra · 3회) · ★**폭 16.0%p** · 항상 통과 16/25 |
...
⇒ 정직한 ② 값은 **평균 73.3% (폭 16.0%p)**입니다.

**왜 ①은 폭 0.000인데 ②는 16.0%p인가**
...
| 4 | 도구 선택 지침에 **원리** 보강 (v3) | — | 80.0% (25건) | ⚠ **폭 16.0%p 안** — 개선이라 말할 수 없다 |
...
⚠ 도구 선택 실패 4건 남음      답변은 맞는데 도구 집합이 다르다 (G01·G04·G11·G17)
...
3  ② 를 로컬 7B 로도 잰다 — 「모델을 바꾸면 얼마나 떨어지나」를 알아야
