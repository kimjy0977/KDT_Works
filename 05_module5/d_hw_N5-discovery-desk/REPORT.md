...
| ② 답변 통과율 | **평균 74.7%** (gpt-5.6-terra · 3회) · 폭 4.0%p · 항상 통과 17/25 |
| ★홀드아웃 | **6/10 (60.0%)** — 지침을 고칠 때 **한 번도 안 본** 문항 |
...
| 4 | 도구 선택 지침에 **원리** 보강 (v3) | — | 80.0% (1회) | ⚠ **폭 안** — 개선이라 말할 수 없다 |
| 6 | ★`agent.py` 라우팅 지침 v1 → v2 | — | 73.3% → **74.7%** · **폭 16.0 → 4.0%p** | 평균이 아니라 **흔들림**이 줄었다 |
