...
| 지표 | 값 | 비고 |
|---|---|---|
| ① 의도 분류 — **gpt-5.6-luna** | **macro F1 0.915** · 범위 밖 78.6~85.7% | 채점 55건 · 폭 0.000(2회) |
| ① 의도 분류 — 로컬 qwen2.5:7b | macro F1 0.878 · 범위 밖 80.0% | 폭 0.000(3회) |
| ① 의도 분류 — 규칙 라우터 | macro F1 0.976 · 범위 밖 85.7% | ⚠ **과적합** — 성적이 아니라 기준선 |
| ② 답변 통과율 — **gpt-5.6-terra** | **20 / 25 (80.0%)** | 행동 판정 25건 전부 일치 |
| 가드레일 | 오탐 1건 (큰 수 쪼개기) | `guard_desk.py --audit` |
